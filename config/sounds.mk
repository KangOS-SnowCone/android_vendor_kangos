...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/kangos/sounds/pixel/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)

# 2019 Material product sounds (CC-BY 4.0)
# Source: https://material.io/design/sound/sound-resources.html
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/kangos/sounds/material/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)
