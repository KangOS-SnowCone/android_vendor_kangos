...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/kangos/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/kangos/overlay/themes/"
overlays_path_temp="$ANDROID_BUILD_TOP/overlays_temp"
overlays_zip_name="kangos_overlays.zip"
